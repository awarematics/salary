...
CREATE TABLE g_salary(a int, b salary);

CREATE FUNCTION g_salary_consistent(internal,int4,int,oid,internal)
RETURNS bool
...
CREATE FUNCTION g_salary_same(internal, internal, internal)
RETURNS internal
AS '$libdir/postgis-2.1'
LANGUAGE C IMMUTABLE STRICT;
